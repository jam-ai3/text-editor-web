const GeminiPrompts = {
  ...
  paraphrase: {
    academic: (selected: string) =>
      GeminiPrompts.paraphrasePrompt("academic", selected),
    persuasive: (selected: string) =>
      GeminiPrompts.paraphrasePrompt("persuasive", selected),
    professional: (selected: string) =>
      GeminiPrompts.paraphrasePrompt("professional", selected),
    simple: (selected: string) =>
      GeminiPrompts.paraphrasePrompt("simple", selected),
  },

  customParaphrase: (customTone: string, selected: string) =>
    GeminiPrompts.paraphrasePrompt(customTone, selected),
};
